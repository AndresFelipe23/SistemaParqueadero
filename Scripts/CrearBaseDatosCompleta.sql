...
BEGIN
    ...
    ON 
    ( NAME = 'SistemaParqueadero',
      FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\SistemaParqueadero.mdf',
      SIZE = 100MB,
      MAXSIZE = 500MB,
      FILEGROWTH = 10MB )
    LOG ON
    ( NAME = 'SistemaParqueadero_Log',
      FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\SistemaParqueadero_Log.ldf',
      SIZE = 10MB,
      MAXSIZE = 100MB,
      FILEGROWTH = 5MB );
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Crear movimiento de caja (apertura si es necesario)
